...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (name && password) {
      ...
      dispatch(User.login(name, password, from));
    }
  };
  ...
  return (
    <div className="bg-login-bg">
      <div className="bg-white bg-opacity-90 h-screen flex p-0 m-0">
        <form name="form" onSubmit={handleSubmit} className="my-automx-auto px-5 sm:px-8 py-8 w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
